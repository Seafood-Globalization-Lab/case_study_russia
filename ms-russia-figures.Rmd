...
# Fill version
consumption_of_rus_p <- consumption %>%
...
# Fill version
rus_foreign_consumption_p <- consumption %>%
  filter(consumer_iso3c == "RUS", 
         source_country_iso3c != "RUS") %>%
  mutate(path = case_when(
...
ggsave("fig1.png", device = "png", height = 5, width = 6.5, units = "in")
```
...
species_rank_5 <- species_rank_df %>%
  ...
  theme(
    ...
    legend.key.size = unit(1, units = "line"),
