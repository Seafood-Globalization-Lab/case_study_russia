...
consumption_russian_ts_fill <- consumption %>%
  ...
  mutate(sanctions_towards_russia = case_when(
    sanctions_towards_russia == "Did not impose sanctions" ~ "Friendly countries' consumption\nof seafood from Russia",
...
consumption_by_russia_ts_fill <- consumption %>%
  ...
  mutate(source_sanctions_towards_russia = case_when(
    source_sanctions_towards_russia == "Did not impose sanctions" ~ "Russian consumption of seafood\nfrom friendly countries",
...
# Percent of US consumption moving through intermediate country
consumption %>%
  filter(consumer_iso3c == "USA", source_country_iso3c == "RUS", year %in% 2015:2019) %>% 
  mutate(path = case_when(
